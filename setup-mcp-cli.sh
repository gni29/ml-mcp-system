...
echo "🎯 고급 기능:"
echo "  - 자동 파일 감지 및 분석"
echo "  - 다양한 데이터 형식 지원 (CSV, Excel, JSON 등)"
echo "  - 실시간 시각화 및 차트 생성"
echo "  - 머신러닝 모델 자동 훈련"
echo "  - 시스템 상태 모니터링"
echo "  - 대화 기록 및 결과 저장"
echo ""
echo "🚪 종료 방법:"
echo "  - 'exit' 또는 'quit' 입력"
echo "  - Ctrl+C 키 조합"
echo ""
echo "🔍 문제 해결:"
echo "  - 연결 오류 시: ollama serve 실행 상태 확인"
echo "  - 모델 오류 시: ollama list로 설치된 모델 확인"
echo "  - 권한 오류 시: chmod +x mcp-cli.js 실행"
echo "  - 로그 확인: ./logs/ 디렉토리 참조"
echo ""
echo "📚 추가 정보:"
echo "  - GitHub: https://github.com/your-repo/ml-mcp-system"
echo "  - 문서: README.md 파일 참조"
echo "  - 버그 리포트: GitHub Issues 사용"
echo ""
